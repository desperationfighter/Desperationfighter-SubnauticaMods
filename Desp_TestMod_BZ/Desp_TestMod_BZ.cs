...
namespace Desp_TestMod_BZ
{
    [QModCore]
    public static class Desp_TestMod_BZ_Class
    {
        [QModPatch]
        public static void Desp_TestMod_BZ_InitializationMethod()
        {
            Logger.Log(Logger.Level.Debug, "Desp_TestMod_BZ_Initialization");

            Harmony harmony = new Harmony("Desp_TestMod_BZ");
            harmony.PatchAll(Assembly.GetExecutingAssembly());

            Logger.Log(Logger.Level.Info, "Desp_TestMod_BZ Patched");
