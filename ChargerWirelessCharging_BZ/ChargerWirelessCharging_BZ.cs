...
//For item
using ChargerWirelessCharging_BZ.Item;
//
using ChargerWirelessCharging_BZ.Managment;
using System.IO;
using System;

namespace ChargerWirelessCharging_BZ
{
    ...
    [QModCore]
    public class ChargerWirelessCharging_BZ
    {
        ...
        public static void ChargerWirelessCharging_InitializationMethod()
        {
            ...
            Harmony harmony = new Harmony("ChargerWirelessCharging_BZ");
            harmony.PatchAll(Assembly.GetExecutingAssembly());
            Logger.Log(Logger.Level.Info, "ChargerWirelessCharging_BZ Patched");
        }
    }
}
