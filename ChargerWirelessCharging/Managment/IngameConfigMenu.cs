...
namespace ChargerWirelessCharging.Managment
{
    ...
    public class IngameConfigMenu : ConfigFile
    {
        ...
        [Slider("Wireless Charge Speed", 0.001f , 0.01f , Step = 0.001f, DefaultValue = 0.004f, Format = "{0:F4}", Tooltip = "[Default=0.004] You want faster Wireless Charging ? No Problem here you go. Default Charging Speed for >non< Wireless is 0.005 as reference.")]
