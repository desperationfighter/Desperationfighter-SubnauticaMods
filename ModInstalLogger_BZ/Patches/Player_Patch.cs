...
namespace ModInstalLogger_BZ.Patches
{
    ...
    public static class Player_Awake_Patch
    {
        ...
        public static void Postfix()
        {
            ...
            string tmppath = Path.Combine(CurrentSavegameDatadir, ModInstalLogger_BZ.Listfilename_Savegame);
            ...
            {
                string savepath = Path.Combine(CurrentSavegameDatadir, ModInstalLogger_BZ.Listfilename_Savegame_Userreadable);
        ...
        {
            string file = Path.Combine(path, ModInstalLogger_BZ.Listfilename_Savegame_Added);
            return file;
        }

        public static string GetPath_SavegameModListChange_Removed(string path)
        {
            string file = Path.Combine(path, ModInstalLogger_BZ.Listfilename_Savegame_Removed);
            return file;
        }
    }
}
